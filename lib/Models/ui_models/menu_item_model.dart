...
List<MenuItemsModel> teacherMenuItems = [
  ...
  const MenuItemsModel(index: 9, title: "OBS Result", svg: "assets/images/chart-pie-alt.svg", page: ObsResult()),
];
...
List<MenuItemsModel> choiceTeacherMenuItems = [
  ...
  // const MenuItemsModel(index: 7, title: "Leave Apply", svg: "assets/images/clock-three 1.svg", page: LeaveRequest()),
  const MenuItemsModel(index: 6, title: "OBS Result", svg: "assets/images/chart-pie-alt.svg", page: ObsResult()),
];