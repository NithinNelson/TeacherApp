...
class _CallNotAnsweredState extends State<CallNotAnswered> {
  ...
  SubmitRequest() async {
    ...
    if (jsonresponse.statusCode == 200) {
      await snackBar(context: context, message: "Submitted Successfully", color: Colors.red);
            ...
            child: isPresses
              ...
              onTap: () {
                if (remarkController.text == null ||
                  ...
                  snackBar(context: context, message: "Please Fill the Required Field", color: Colors.red);
