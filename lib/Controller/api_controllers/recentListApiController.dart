...
class RecentListApiController extends GetxController {
  ...
  Future<void> fetchRecentList() async {
    ...
    try {
      ...
      List<TeacherSubject> teacherSubjects = Get.find<TimeTableController>().teacherSubjects.value;
      ...
      if (resp['status']['code'] == 200) {
        ...
        print("-----------inprogressdacccccta..${recentData.value}-----------");
        isLoaded.value = true;
        for (var sub in recentData.value) {
         if(sub.isprogress ?? false) {
         ...
         else
           {
             ...
             print("-----------inprogressdata..$progressCompletedData-----------");
           }
        }
